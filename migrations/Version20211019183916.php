 ...
 */
final class Version20211019183916 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Create Entity EmployeeType, Employee, FeeSheet, State, StandardFeesLine, StandardFees, VariableFeesLine';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE fee_sheet (id INT AUTO_INCREMENT NOT NULL, employees_id INT DEFAULT NULL, state_id INT DEFAULT NULL, date DATE NOT NULL, nb_documents INT NOT NULL, valid_amount INT NOT NULL, INDEX IDX_3433FDC08520A30B (employees_id), INDEX IDX_3433FDC05D83CC1 (state_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE standard_fees (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, unit_amount INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE variable_fees_line (id INT AUTO_INCREMENT NOT NULL, fee_sheet_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, date DATE NOT NULL, amount INT NOT NULL, INDEX IDX_AA26016BE92CADA2 (fee_sheet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
